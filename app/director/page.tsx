          ...
          <main className="container mx-auto px-4 py-12 flex-1 flex items-center justify-center">
            <div className="text-center max-w-md">
              ...
              <button
                ...
                className="flex items-center justify-center gap-2 text-lg px-8 py-6 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 bg-primary text-primary-foreground font-medium focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 mx-auto disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
              >
                {signInLoading ? (
                  <>
